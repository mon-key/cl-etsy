...
((:COUNT . 152)
 (:RESULTS
  ...
  ((:NAME . "getCountry") 
   ...
   (:DEFAULTS) (:TYPE . "Country") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllFeaturedTreasuries")
   ...
   (:PARAMS
    ...
    (:PAGE . "int")
    (:REGION . "region"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)
              (:REGION . "__ALL_REGIONS__"))
   (:TYPE . "FeaturedTreasury") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "getListing") 
   ...
   (:URI . "/listings/:listing_id") (:PARAMS (:LISTING--ID . "array(int)"))
   (:DEFAULTS)
   (:TYPE . "Listing")
   (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "deleteListingImage") 
   ...
   (:URI . "/listings/:listing_id/images/:listing_image_id")
   (:PARAMS (:LISTING--ID . "int") (:LISTING--IMAGE--ID . "int")) (:DEFAULTS)
   (:TYPE . "ListingImage") (:VISIBILITY . "private")
   (:HTTP--METHOD . "DELETE"))
  ...
  ((:NAME . "findAllListingShippingInfo")
   ...
   (:PARAMS (:LISTING--ID . "int") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "ShippingInfo")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "createShippingInfo")
   (:DESCRIPTION . "Creates a new ShippingInfo.")
   (:URI . "/listings/:listing_id/shipping/info")
   (:PARAMS (:ORIGIN--COUNTRY--ID . "int") (:DESTINATION--COUNTRY--ID . "int")
            (:PRIMARY--COST . "float") (:SECONDARY--COST . "float")
            (:REGION--ID . "int") (:LISTING--ID . "int"))
   (:DEFAULTS (:DESTINATION--COUNTRY--ID) (:REGION--ID))
   (:TYPE . "ShippingInfo") (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "getListingTranslation")
   ...
   (:PARAMS (:LISTING--ID . "int") (:LANGUAGE . "language")) (:DEFAULTS)
   (:TYPE . "ListingTranslation") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllListingActive")
   ...
   (:URI . "/listings/active")
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:KEYWORDS . "text") (:SORT--ON . "enum(created, price, score)")
            (:SORT--ORDER . "enum(up, down)") (:MIN--PRICE . "float")
            (:MAX--PRICE . "float") (:COLOR . "color_triplet")
            (:COLOR--ACCURACY . "color_wiggle") (:TAGS . "array(string)")
            (:MATERIALS . "array(string)") (:CATEGORY . "category")
            (:LOCATION . "string") (:LAT . "latitude") (:LON . "longitude")
            (:GEO--LEVEL . "enum(city, state, country)"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:KEYWORDS)
              (:SORT--ON . "created") (:SORT--ORDER . "down") (:MIN--PRICE) (:MAX--PRICE)
              (:COLOR) (:COLOR--ACCURACY . 0) (:TAGS) (:MATERIALS) (:CATEGORY)
              (:LOCATION) (:LAT) (:LON) (:GEO--LEVEL . "city"))
   (:TYPE . "Listing") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "getOrder") 
   (:DESCRIPTION . "Retrieves a Order by id.")
   (:URI . "/orders/:order_id") (:PARAMS (:ORDER--ID . "array(int)"))
   (:DEFAULTS) (:TYPE . "Order") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllOrderReceipts")
   ...
   (:PARAMS (:ORDER--ID . "int") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Receipt")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "findPayment") 
   (:DESCRIPTION . "Get a Direct Checkout Payment")
   (:URI . "/payments/:payment_id") (:PARAMS (:PAYMENT--ID . "int"))
   (:DEFAULTS) (:TYPE . "Payment") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "findPaymentAdjustments")
   (:DESCRIPTION . "Get a Payment Adjustments from a Payment Id")
   (:URI . "/payments/:payment_id/adjustments")
   (:PARAMS (:PAYMENT--ID . "int") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "PaymentAdjustment") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findPaymentAdjustment")
   ...
   (:PARAMS (:PAYMENT--ID . "int") (:PAYMENT--ADJUSTMENT--ID . "int"))
   (:DEFAULTS) (:TYPE . "PaymentAdjustment") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findPaymentAdjustmentItem")
   ...
   (:PARAMS (:PAYMENT--ID . "int") (:PAYMENT--ADJUSTMENT--ID . "int")
            (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "PaymentAdjustmentItem") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findPaymentAdjustmentItem")
   ...
   (:DEFAULTS) (:TYPE . "PaymentAdjustmentItem") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "createPaymentTemplate")
   (:DESCRIPTION . "Creates a new PaymentTemplate")
   (:URI . "/payments/templates")
   (:PARAMS (:ALLOW--CHECK . "boolean") (:ALLOW--MO . "boolean")
            (:ALLOW--OTHER . "boolean") (:ALLOW--PAYPAL . "boolean")
            (:ALLOW--CC . "boolean") (:PAYPAL--EMAIL . "string") (:NAME . "string")
            (:FIRST--LINE . "string") (:SECOND--LINE . "string") (:CITY . "string")
            (:STATE . "string") (:ZIP . "string") (:COUNTRY--ID . "int"))
   (:DEFAULTS (:ALLOW--CHECK) (:ALLOW--MO) (:ALLOW--OTHER) (:ALLOW--PAYPAL)
              (:ALLOW--CC) (:PAYPAL--EMAIL) (:NAME) (:FIRST--LINE) (:SECOND--LINE)
              (:CITY) (:STATE) (:ZIP) (:COUNTRY--ID))
   (:TYPE . "PaymentTemplate") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
     
  ((:NAME . "getPaymentTemplate")
   (:DESCRIPTION . "Retrieves a PaymentTemplate by id.")
   (:URI . "/payments/templates/:payment_template_id")
   (:PARAMS (:PAYMENT--TEMPLATE--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "PaymentTemplate") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "createReceiptOnSandbox")
   ...
   (:URI . "/receipts") (:PARAMS (:LISTING--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "Receipt") (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))
     
  ((:NAME . "getReceipt") 
   (:DESCRIPTION . "Retrieves a Receipt by id.")
   (:URI . "/receipts/:receipt_id") (:PARAMS (:RECEIPT--ID . "array(int)"))
   (:DEFAULTS) (:TYPE . "Receipt") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "updateReceipt") 
   (:DESCRIPTION . "Updates a Receipt")
   (:URI . "/receipts/:receipt_id")
   (:PARAMS (:RECEIPT--ID . "int") (:WAS--PAID . "boolean")
            (:WAS--SHIPPED . "boolean") (:MESSAGE--FROM--SELLER . "string")
            (:MESSAGE--FROM--BUYER . "string"))
   (:DEFAULTS (:WAS--PAID) (:WAS--SHIPPED) (:MESSAGE--FROM--SELLER)
              (:MESSAGE--FROM--BUYER))
   (:TYPE . "Receipt") (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
     
  ((:NAME . "findAllReceiptListings")
   (:DESCRIPTION . "Finds all listings in a receipt")
   (:URI . "/receipts/:receipt_id/listings")
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:RECEIPT--ID . "int") (:DATA--VERSION . "string"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:DATA--VERSION))
   (:TYPE . "Listing") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllReceiptTransactions")
   ...
   (:PARAMS (:RECEIPT--ID . "int") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Transaction")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "findAllRegion") 
   (:DESCRIPTION . "Finds all Region.")
   (:URI . "/regions") (:PARAMS) (:DEFAULTS) (:TYPE . "Region")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "getRegion") 
   (:DESCRIPTION . "Retrieves a Region by id.")
   (:URI . "/regions/:region_id") (:PARAMS (:REGION--ID . "array(int)"))
   (:DEFAULTS) (:TYPE . "Region") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "getServerEpoch")
   (:DESCRIPTION . "Get server time, in epoch seconds notation.")
   (:URI . "/server/epoch") (:PARAMS) (:DEFAULTS) (:TYPE . "Int")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "ping") 
   (:DESCRIPTION . "Check that the server is alive.")
   (:URI . "/server/ping") (:PARAMS) (:DEFAULTS) (:TYPE . "String")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "getShippingInfo")
   (:DESCRIPTION . "Retrieves a ShippingInfo by id.")
   (:URI . "/shipping/info/:shipping_info_id")
   (:PARAMS (:SHIPPING--INFO--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "ShippingInfo") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "updateShippingInfo")
   (:DESCRIPTION . "Updates a ShippingInfo with the given id.")
   (:URI . "/shipping/info/:shipping_info_id")
   (:PARAMS (:SHIPPING--INFO--ID . "int") (:ORIGIN--COUNTRY--ID . "int")
            (:DESTINATION--COUNTRY--ID . "int") (:PRIMARY--COST . "float")
            (:SECONDARY--COST . "float") (:REGION--ID . "int") (:LISTING--ID . "int"))
   (:DEFAULTS (:ORIGIN--COUNTRY--ID) (:DESTINATION--COUNTRY--ID)
     (:CURRENCY--CODE) (:PRIMARY--COST) (:SECONDARY--COST) (:REGION--ID)
     (:LISTING--ID))
   (:TYPE . "ShippingInfo") (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
     
  ((:NAME . "deleteShippingInfo")
   (:DESCRIPTION . "Deletes the ShippingInfo with the given id.")
   (:URI . "/shipping/info/:shipping_info_id")
   (:PARAMS (:SHIPPING--INFO--ID . "int")) (:DEFAULTS) (:TYPE . "ShippingInfo")
   (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))
     
  ((:NAME . "createShippingTemplate")
   (:DESCRIPTION . "Creates a new ShippingTemplate")
   (:URI . "/shipping/templates")
   (:PARAMS (:TITLE . "string") (:ORIGIN--COUNTRY--ID . "int")
            (:DESTINATION--COUNTRY--ID . "int") (:PRIMARY--COST . "float")
            (:SECONDARY--COST . "float") (:DESTINATION--REGION--ID . "int"))
   (:DEFAULTS (:DESTINATION--COUNTRY--ID) (:DESTINATION--REGION--ID))
   (:TYPE . "ShippingTemplate") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
     
  ((:NAME . "getShippingTemplate")
   (:DESCRIPTION . "Retrieves a ShippingTemplate by id.")
   (:URI . "/shipping/templates/:shipping_template_id")
   (:PARAMS (:SHIPPING--TEMPLATE--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "ShippingTemplate") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "updateShippingTemplate")
   (:DESCRIPTION . "Updates a ShippingTemplate")
   (:URI . "/shipping/templates/:shipping_template_id")
   (:PARAMS (:SHIPPING--TEMPLATE--ID . "int") (:TITLE . "string")
            (:ORIGIN--COUNTRY--ID . "int"))
   (:DEFAULTS (:TITLE) (:ORIGIN--COUNTRY--ID)) (:TYPE . "ShippingTemplate")
   (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
     
  ((:NAME . "deleteShippingTemplate")
   (:DESCRIPTION . "Deletes the ShippingTemplate with the given id.")
   (:URI . "/shipping/templates/:shipping_template_id")
   (:PARAMS (:SHIPPING--TEMPLATE--ID . "int")) (:DEFAULTS)
   (:TYPE . "ShippingTemplate") (:VISIBILITY . "private")
   (:HTTP--METHOD . "DELETE"))
  ...
  ((:NAME . "findAllShippingTemplateEntries")
   ...
   (:PARAMS (:SHIPPING--TEMPLATE--ID . "int") (:LIMIT . "int")
            (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "ShippingTemplateEntry") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "createShippingTemplateEntry")
   (:DESCRIPTION . "Creates a new ShippingTemplateEntry")
   (:URI . "/shipping/templates/entries")
   (:PARAMS (:SHIPPING--TEMPLATE--ID . "int")
            (:DESTINATION--COUNTRY--ID . "int") (:PRIMARY--COST . "float")
            (:SECONDARY--COST . "float") (:DESTINATION--REGION--ID . "int"))
   (:DEFAULTS (:DESTINATION--COUNTRY--ID) (:DESTINATION--REGION--ID))
   (:TYPE . "ShippingTemplateEntry") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "getShippingTemplateEntry")
   ...
   (:PARAMS (:SHIPPING--TEMPLATE--ENTRY--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "ShippingTemplateEntry") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "updateShippingTemplateEntry")
   ...
   (:URI . "/shipping/templates/entries/:shipping_template_entry_id")
   (:PARAMS (:SHIPPING--TEMPLATE--ENTRY--ID . "int")
            (:DESTINATION--COUNTRY--ID . "int") (:PRIMARY--COST . "float")
            (:SECONDARY--COST . "float"))
   (:DEFAULTS (:DESTINATION--COUNTRY--ID) (:PRIMARY--COST) (:SECONDARY--COST))
   (:TYPE . "ShippingTemplateEntry") (:VISIBILITY . "private")
   (:HTTP--METHOD . "PUT"))
  ...
  ((:NAME . "deleteShippingTemplateEntry")
   ...
   (:URI . "/shipping/templates/entries/:shipping_template_entry_id")
   (:PARAMS (:SHIPPING--TEMPLATE--ENTRY--ID . "int")) (:DEFAULTS)
   (:TYPE . "ShippingTemplateEntry") (:VISIBILITY . "private")
   (:HTTP--METHOD . "DELETE"))
  ...
  ((:NAME . "findAllShops")
   ...
   (:URI . "/shops")
   (:PARAMS (:SHOP--NAME . "string (length >= 3)") (:LIMIT . "int")
            (:OFFSET . "int") (:PAGE . "int") (:LAT . "latitude") (:LON . "longitude")
            (:DISTANCE--MAX . "float"))
   (:DEFAULTS (:SHOP--NAME) (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:LAT) (:LON)
              (:DISTANCE--MAX . 35))
   (:TYPE . "Shop") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "getShop") 
   (:DESCRIPTION . "Retrieves a Shop by id.")
   (:URI . "/shops/:shop_id") (:PARAMS (:SHOP--ID . "array(shop_id_or_name)"))
   (:DEFAULTS) (:TYPE . "Shop") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "updateShop") 
   (:DESCRIPTION . "Updates a Shop")
   (:URI . "/shops/:shop_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:TITLE . "string")
            (:ANNOUNCEMENT . "text") (:IS--REFUSING--ALCHEMY . "boolean")
            (:ALCHEMY--MESSAGE . "string") (:SALE--MESSAGE . "text")
            (:POLICY--WELCOME . "text") (:POLICY--PAYMENT . "text")
            (:POLICY--SHIPPING . "text") (:POLICY--REFUNDS . "text")
            (:POLICY--ADDITIONAL . "text") (:POLICY--SELLER--INFO . "text"))
   (:DEFAULTS (:TITLE) (:ANNOUNCEMENT) (:IS--REFUSING--ALCHEMY)
              (:ALCHEMY--MESSAGE) (:SALE--MESSAGE) (:POLICY--WELCOME) (:POLICY--PAYMENT)
              (:POLICY--SHIPPING) (:POLICY--REFUNDS) (:POLICY--ADDITIONAL)
              (:POLICY--SELLER--INFO))
   (:TYPE . "Shop") (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
     
  ((:NAME . "uploadShopBanner")
   (:DESCRIPTION . "Upload a new shop banner image")
   (:URI . "/shops/:shop_id/appearance/banner")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:IMAGE . "image")) (:DEFAULTS)
   (:TYPE . "Shop") (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))
     
  ((:NAME . "deleteShopBanner") 
   (:DESCRIPTION . "Deletes a shop banner image")
   (:URI . "/shops/:shop_id/appearance/banner")
   (:PARAMS (:SHOP--ID . "shop_id_or_name")) (:DEFAULTS) (:TYPE . "Shop")
   (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))
     
  ((:NAME . "findAllShopCoupons")
   (:DESCRIPTION . "Retrieves all Shop_Coupons by shop_id")
   (:URI . "/shops/:shop_id/coupons") (:PARAMS (:SHOP--ID . "shop_id_or_name"))
   (:DEFAULTS) (:TYPE . "Coupon") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
     
  ((:NAME . "createCoupon") 
   (:DESCRIPTION . "Creates a new Coupon.")
   (:URI . "/shops/:shop_id/coupons")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:COUPON--CODE . "string")
            (:PCT--DISCOUNT . "int") (:SELLER--ACTIVE . "boolean")
            (:FREE--SHIPPING . "boolean") (:DOMESTIC--ONLY . "boolean"))
   (:DEFAULTS (:PCT--DISCOUNT) (:SELLER--ACTIVE . "false")
     (:FREE--SHIPPING . "false") (:DOMESTIC--ONLY . "false"))
   (:TYPE . "Coupon") (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))
     
  ((:NAME . "findCoupon")
   (:DESCRIPTION . "Retrieves a Shop_Coupon by id and shop_id")
   (:URI . "/shops/:shop_id/coupons/:coupon_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:COUPON--ID . "int")) (:DEFAULTS)
   (:TYPE . "Coupon") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
     
  ((:NAME . "updateCoupon") 
   (:DESCRIPTION . "Updates a coupon")
   (:URI . "/shops/:shop_id/coupons/:coupon_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:COUPON--ID . "int")
            (:SELLER--ACTIVE . "boolean"))
   (:DEFAULTS (:SELLER--ACTIVE . "false")) (:TYPE . "Coupon")
   (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
  ...
  ((:NAME . "deleteCoupon") 
   ...
   (:URI . "/shops/:shop_id/coupons/:coupon_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:COUPON--ID . "int")) (:DEFAULTS)
   (:TYPE . "Coupon") (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))
     
  ((:NAME . "findLedger") 
   (:DESCRIPTION . "Get a Shop Payment Account Ledger")
   (:URI . "/shops/:shop_id/ledger/") (:PARAMS (:SHOP--ID . "shop_id_or_name"))
   (:DEFAULTS) (:TYPE . "Ledger") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))

  ((:NAME . "findLedgerEntries")
   (:DESCRIPTION . "Get a Shop Payment Account Ledger's Entries")
   (:URI . "/shops/:shop_id/ledger/entries")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "LedgerEntry")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllShopListingsActive")
   ...
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:SHOP--ID . "shop_id_or_name") (:KEYWORDS . "string")
  ...
  ((:NAME . "findAllShopListingsDraft")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Listing")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "getShopListingExpired")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:LISTING--ID . "int")) (:DEFAULTS)
   (:TYPE . "Listing") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllShopReceipts")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:MIN--CREATED . "epoch")
            (:MAX--CREATED . "epoch") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int") (:WAS--PAID . "boolean") (:WAS--SHIPPED . "boolean"))
   (:DEFAULTS (:MIN--CREATED) (:MAX--CREATED) (:LIMIT . 25) (:OFFSET . 0)
              (:PAGE) (:WAS--PAID) (:WAS--SHIPPED))
   (:TYPE . "Receipt") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllShopReceiptsByStatus")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name")
  ...
  ((:NAME . "findAllShopSections")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name")) (:DEFAULTS)
   (:TYPE . "ShopSection") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "createShopSection") 
   (:DESCRIPTION . "Creates a new ShopSection.")
   (:URI . "/shops/:shop_id/sections")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:TITLE . "text")
            (:USER--ID . "int"))
   (:DEFAULTS (:TITLE) (:USER--ID)) (:TYPE . "ShopSection")
   (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "getShopSection")
   ...
   (:DEFAULTS) (:TYPE . "ShopSection") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))

  ((:NAME . "updateShopSection")
   (:DESCRIPTION . "Updates a ShopSection with the given id.")
   (:URI . "/shops/:shop_id/sections/:shop_section_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:SHOP--SECTION--ID . "int")
            (:TITLE . "text") (:USER--ID . "int") (:RANK . "int"))
   (:DEFAULTS (:TITLE) (:USER--ID) (:RANK)) (:TYPE . "ShopSection")
   (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
  ...
  ((:NAME . "deleteShopSection")
   ...
   (:URI . "/shops/:shop_id/sections/:shop_section_id")
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:SHOP--SECTION--ID . "int"))
   (:DEFAULTS) (:TYPE . "ShopSection") (:VISIBILITY . "private")
   (:HTTP--METHOD . "DELETE"))
  ...
  ((:NAME . "findAllShopSectionListings")
   ...
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:SHOP--ID . "shop_id_or_name") (:SHOP--SECTION--ID . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Listing")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllShopSectionListingsActive")
   ...
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:SHOP--ID . "shop_id_or_name") (:SHOP--SECTION--ID . "int")
            (:SORT--ON . "enum(created, price)") (:SORT--ORDER . "enum(up, down)"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:SORT--ON . "created")
              (:SORT--ORDER . "down"))
   (:TYPE . "Listing") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "getShopTranslation")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:SHOP--SECTION--ID . "int")
            (:LANGUAGE . "language"))
   (:DEFAULTS) (:TYPE . "ShopSectionTranslation") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "getShopTranslation")
   ...
   (:PARAMS (:SHOP--ID . "shop_id_or_name") (:LANGUAGE . "language"))
   (:DEFAULTS) (:TYPE . "ShopTranslation") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "getShopSectionTranslationShopSection")
   ...
   (:PARAMS (:SHOP--SECTION--ID . "int")) (:DEFAULTS) (:TYPE . "ShopSection")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "findAllTopCategory")
   (:DESCRIPTION . "Retrieves all top-level Categories.")
   (:URI . "/taxonomy/categories") (:PARAMS) (:DEFAULTS) (:TYPE . "Category")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "findAllTopCategoryChildren")
   (:DESCRIPTION . "Retrieves children of a top-level Category by tag.")
   (:URI . "/taxonomy/categories/:tag") (:PARAMS (:TAG . "string")) (:DEFAULTS)
   (:TYPE . "Category") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllSubCategoryChildren")
   ...
   (:PARAMS (:TAG . "string") (:SUBTAG . "string")) (:DEFAULTS)
   (:TYPE . "Category") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "findSuggestedStyles")
   (:DESCRIPTION . "Retrieve all suggested styles.")
   (:URI . "/taxonomy/styles") (:PARAMS) (:DEFAULTS) (:TYPE . "Style")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findPopularTags")
   ...
   (:URI . "/taxonomy/tags") (:PARAMS (:LIMIT . "int"))
   (:DEFAULTS (:LIMIT . 25)) (:TYPE . "Tag") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllRelatedTags")
   ...
   (:PARAMS (:TAGS . "array(string)") (:LIMIT . "int"))
   (:DEFAULTS (:LIMIT . 25)) (:TYPE . "Tag") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllTeams") 
   ...
   (:URI . "/teams")
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Team")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "findAllUsersForTeam")
   (:DESCRIPTION . "Returns a list of users for a specific team")
   (:URI . "/teams/:team_id/users/")
   (:PARAMS (:TEAM--ID . "int") (:STATUS . "enum(active, invited, pending)")
            (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:STATUS . "active") (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "User") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "findTeams")
   (:DESCRIPTION . "Returns specified team by ID or team name")
   (:URI . "/teams/:team_ids/")
   (:PARAMS (:TEAM--IDS . "array(team_id_or_name)")) (:DEFAULTS)
   (:TYPE . "Team") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "getTransaction") 
   (:DESCRIPTION . "Retrieves a Transaction by id.")
   (:URI . "/transactions/:transaction_id")
   (:PARAMS (:TRANSACTION--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "Transaction") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))

  ((:NAME . "findAllTreasuries")
   (:DESCRIPTION . "Search Treasuries or else List all Treasuries")
   (:URI . "/treasuries")
   (:PARAMS (:KEYWORDS . "treasury_search_string")
            (:SORT--ON . "enum(hotness, created)") (:SORT--ORDER . "enum(up, down)")
            (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:KEYWORDS) (:SORT--ON . "hotness") (:SORT--ORDER . "down")
              (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "Treasury") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "createTreasury") 
   (:DESCRIPTION . "Create a Treasury")
   (:URI . "/treasuries")
   (:PARAMS (:TITLE . "treasury_title") 
            (:DESCRIPTION . "treasury_description")
            (:LISTING--IDS . "array(int)") (:TAGS . "array(string)")
            (:PRIVATE . "boolean"))
   (:DEFAULTS (:TAGS . "") (:PRIVATE . 0)) (:TYPE . "Treasury")
   (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))

  ((:NAME . "getTreasury") 
   (:DESCRIPTION . "Get a Treasury")
   (:URI . "/treasuries/:treasury_key")
   (:PARAMS (:TREASURY--KEY . "treasury_id")) (:DEFAULTS) (:TYPE . "Treasury")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "deleteTreasury") 
   (:DESCRIPTION . "Delete a Treasury")
   (:URI . "/treasuries/:treasury_key") (:PARAMS) (:DEFAULTS)
   (:TYPE . "Treasury") (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))

  ((:NAME . "findTreasuryComments")
   (:DESCRIPTION . "Get a Treasury's Comments")
   (:URI . "/treasuries/:treasury_key/comments")
   (:PARAMS (:TREASURY--KEY . "treasury_id") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "ForumPost")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "postTreasuryComment")
   (:DESCRIPTION . "Leave a comment on a Treasury List")
   (:URI . "/treasuries/:treasury_key/comments")
   (:PARAMS (:MESSAGE . "forum_post")) (:DEFAULTS) (:TYPE . "ForumPost")
   (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))

  ((:NAME . "deleteTreasuryComment")
   (:DESCRIPTION . "Delete a given comment on a Treasury List")
   (:URI . "/treasuries/:treasury_key/comments/:comment_id") (:PARAMS)
   (:DEFAULTS) (:TYPE . "ForumPost") (:VISIBILITY . "private")
   (:HTTP--METHOD . "DELETE"))

  ((:NAME . "describeOccasionEnum")
   (:DESCRIPTION . "Describes the legal values for Listing.occasion.")
   (:URI . "/types/enum/occasion") (:PARAMS) (:DEFAULTS) (:TYPE . "DataType")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "describeRecipientEnum")
   (:DESCRIPTION . "Describes the legal values for Listing.recipient.")
   (:URI . "/types/enum/recipient") (:PARAMS) (:DEFAULTS) (:TYPE . "DataType")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "describeWhenMadeEnum")
   (:DESCRIPTION . "Describes the legal values for Listing.when_made.")
   (:URI . "/types/enum/when_made") (:PARAMS) (:DEFAULTS) (:TYPE . "DataType")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "describeWhoMadeEnum")
   (:DESCRIPTION . "Describes the legal values for Listing.who_made.")
   (:URI . "/types/enum/who_made") (:PARAMS) (:DEFAULTS) (:TYPE . "DataType")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUsers")
   ...
   (:URI . "/users")
   (:PARAMS (:KEYWORDS . "string") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:KEYWORDS) (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "User")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "getUser") 
   (:DESCRIPTION . "Retrieves a User by id.")
   (:URI . "/users/:user_id") (:PARAMS (:USER--ID . "array(user_id_or_name)"))
   (:DEFAULTS) (:TYPE . "User") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserAddresses")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "UserAddress")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))

  ((:NAME . "createUserAddress") 
   (:DESCRIPTION . "Creates a new UserAddress.")
   (:URI . "/users/:user_id/addresses/")
   (:PARAMS (:USER--ID . "user_id_or_name") (:NAME . "string")
            (:FIRST--LINE . "string") (:SECOND--LINE . "string") (:CITY . "string")
            (:STATE . "string") (:ZIP . "string") (:COUNTRY--ID . "int"))
   (:DEFAULTS (:SECOND--LINE) (:STATE)) (:TYPE . "UserAddress")
   (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))

  ((:NAME . "getUserAddress") 
   (:DESCRIPTION . "Retrieves a UserAddress by id.")
   (:URI . "/users/:user_id/addresses/:user_address_id")
   (:PARAMS (:USER--ADDRESS--ID . "array(int)")) (:DEFAULTS)
   (:TYPE . "UserAddress") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))

  ((:NAME . "deleteUserAddress")
   (:DESCRIPTION . "Deletes the UserAddress with the given id.")
   (:URI . "/users/:user_id/addresses/:user_address_id")
   (:PARAMS (:USER--ADDRESS--ID . "int")) (:DEFAULTS) (:TYPE . "UserAddress")
   (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))

  ((:NAME . "uploadAvatar") 
   (:DESCRIPTION . "Upload a new user avatar image")
   (:URI . "/users/:user_id/avatar")
   (:PARAMS (:SRC . "string") (:USER--ID . "user_id_or_name")
            (:IMAGE . "image"))
   (:DEFAULTS (:SRC) (:USER--ID) (:IMAGE)) (:TYPE . "Avatar")
   (:VISIBILITY . "private") (:HTTP--METHOD . "POST"))

  ((:NAME . "getAvatarImgSrc") 
   (:DESCRIPTION . "Get avatar image source")
   (:URI . "/users/:user_id/avatar/src")
   (:PARAMS (:USER--ID . "user_id_or_name")) (:DEFAULTS (:USER--ID))
   (:TYPE . "Avatar") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))

  ((:NAME . "getUserBillingOverview")
   (:DESCRIPTION . "Retrieves the user's current balance.")
   (:URI . "/users/:user_id/billing/overview")
   (:PARAMS (:USER--ID . "user_id_or_name")) (:DEFAULTS)
   (:TYPE . "BillingOverview") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))

  ((:NAME . "getAllUserCarts") 
   (:DESCRIPTION . "Get a user's Carts")
   (:URI . "/users/:user_id/carts") (:PARAMS (:USER--ID . "user_id_or_name"))
   (:DEFAULTS) (:TYPE . "Cart") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))

  ((:NAME . "addToCart") 
   (:DESCRIPTION . "Add a listing to a cart")
   (:URI . "/users/:user_id/carts")
   (:PARAMS (:USER--ID . "user_id_or_name") (:LISTING--ID . "int")
            (:QUANTITY . "int"))
   (:DEFAULTS (:QUANTITY . 1)) (:TYPE . "Cart") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "removeCartListing")
   ...
   (:URI . "/users/:user_id/carts")
   (:PARAMS (:USER--ID . "user_id_or_name") (:LISTING--ID . "int")) (:DEFAULTS)
   (:TYPE . "Cart") (:VISIBILITY . "private") (:HTTP--METHOD . "DELETE"))

  ((:NAME . "getUserCart") 
   (:DESCRIPTION . "Get a cart")
   (:URI . "/users/:user_id/carts/:cart_id")
   (:PARAMS (:USER--ID . "user_id_or_name") (:CART--ID . "cart_id"))
   (:DEFAULTS) (:TYPE . "Cart") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "updateCart") 
   ...
   (:URI . "/users/:user_id/carts/:cart_id")
   (:PARAMS (:USER--ID . "user_id_or_name") (:CART--ID . "cart_id")
            (:DESTINATION--COUNTRY--ID . "int") (:MESSAGE--TO--SELLER . "text")
            (:COUPON--CODE . "string"))
   (:DEFAULTS (:DESTINATION--COUNTRY--ID) (:MESSAGE--TO--SELLER)
     (:COUPON--CODE))
   (:TYPE . "Cart") (:VISIBILITY . "private") (:HTTP--METHOD . "PUT"))
  ...
  ((:NAME . "findAllCartListings")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:CART--ID . "cart_id"))
   (:DEFAULTS) (:TYPE . "Listing") (:VISIBILITY . "private")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserCharges")
   ...
   (:PARAMS (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int")
            (:USER--ID . "user_id_or_name") (:SORT--ORDER . "enum(up, down)")
            (:MIN--CREATED . "epoch") (:MAX--CREATED . "epoch"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:SORT--ORDER . "up")
              (:MIN--CREATED) (:MAX--CREATED))
   (:TYPE . "BillCharge") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserFavoredBy")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "FavoriteUser")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserFavoriteListings")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "FavoriteListing")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findUserFavoriteListings")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LISTING--ID . "int")) (:DEFAULTS)
   (:TYPE . "FavoriteListing") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "createUserFavoriteListings")
   ...
   (:URI . "/users/:user_id/favorites/listings/:listing_id")
   (:PARAMS (:USER--ID . "user_id_or_name") (:LISTING--ID . "int")) (:DEFAULTS)
   (:TYPE . "FavoriteListing") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "findUserFavoriteUsers")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name")
            (:TARGET--USER--ID . "user_id_or_name"))
   (:DEFAULTS) (:TYPE . "FavoriteUser") (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "createUserFavoriteUsers")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name")
            (:TARGET--USER--ID . "user_id_or_name"))
   (:DEFAULTS) (:TYPE . "FavoriteUser") (:VISIBILITY . "private")
   (:HTTP--METHOD . "POST"))
  ...
  ((:NAME . "findAllUserFeedbackAsAuthor")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Feedback")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllFeedbackFromBuyers")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:USER--ID) (:LIMIT . 25) (:OFFSET . 0) (:PAGE))
   (:TYPE . "Feedback") (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserOrders")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:MIN--CREATED . "epoch")
            (:MAX--CREATED . "epoch") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:MIN--CREATED) (:MAX--CREATED) (:LIMIT . 25) (:OFFSET . 0)
              (:PAGE))
   (:TYPE . "Order") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserPayments")
   ...
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE) (:SORT--ORDER . "up")
              (:MIN--CREATED) (:MAX--CREATED))
   (:TYPE . "BillPayment") (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserShippingTemplates")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "ShippingTemplate")
   (:VISIBILITY . "private") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserShops")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name") (:LIMIT . "int") (:OFFSET . "int")
            (:PAGE . "int"))
   (:DEFAULTS (:LIMIT . 25) (:OFFSET . 0) (:PAGE)) (:TYPE . "Shop")
   (:VISIBILITY . "public") (:HTTP--METHOD . "GET"))
  ...
  ((:NAME . "findAllUserTreasuries")
   ...
   (:PARAMS (:USER--ID . "user_id_or_name")
            (:SORT--ON . "enum(hotness, created)") (:SORT--ORDER . "enum(up, down)")
            (:LIMIT . "int") (:OFFSET . "int") (:PAGE . "int"))
   (:DEFAULTS (:SORT--ON . "hotness") (:SORT--ORDER . "down") (:LIMIT . 25)
              (:OFFSET . 0) (:PAGE))
   (:TYPE . "Treasury")
   (:VISIBILITY . "public")
   (:HTTP--METHOD . "GET")))
